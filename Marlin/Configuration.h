...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 97.17
  #define DEFAULT_bedKi 14.46
  #define DEFAULT_bedKd 435.34
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1000, 1000, 15, 25 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43.5, -6, -2.23 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MANUAL_PROBE_START_Z 0.23  // (mm) Comment out to use the last-measured height
#endif
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_HEIGHT      2.25  // (mm) Z height of nozzle at leveling points
...
//attempts to change LCD timing to reduce artifacting
